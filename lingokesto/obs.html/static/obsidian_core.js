...
var gzip_hash = '193697177562139923509714343480319982612'                       // used to check whether the localStorage data is stale
...
function get_html_url_prefix(){
    return '/lingokesto'  // this value is replaced by the actual url prefix when compiled
}
